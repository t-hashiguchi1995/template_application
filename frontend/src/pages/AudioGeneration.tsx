...
function AudioGeneration() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await apiClient.post('/audio/generate', {
        text,
        voice: 'default',
  ...
  return (
    <div className="bg-gray-900 rounded-lg p-8 shadow-lg">
      <h2 className="text-2xl font-bold text-white mb-6">音声生成（TTS）</h2>
      <div className="mb-6">
      ...
      {audioUrl && (
        <div className="mt-6 p-6 bg-gray-800 border border-gray-700 rounded-lg">
          <h3 className="text-lg font-semibold text-white mb-4">生成された音声</h3>
